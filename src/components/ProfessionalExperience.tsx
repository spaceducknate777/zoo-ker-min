  ...
  const experiences = [
    {
      ...
      location: "Remote",
      description:
        "Boosted conversion 25% via responsive redesign of a high-volume fintech platform. Architected a unified design system with 50+ components, cutting handoff time 40%.",
    },
    {
      ...
      description:
        "Led UX for 5 federal agencies including NASA, NIH, and DOT. 30% average accessibility improvement. Redesigned NIH CDE Repository — search time down 45%.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Built a narrative-driven iconography system adopted into the official USAA library, used by 12M+ members. Mobile-first financial tools improved engagement 25%.",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-10 pt-8 border-t border-border">
          <p className="text-xs text-muted-foreground leading-relaxed max-w-2xl">
            <span className="text-foreground font-medium">2023 – Present (Independent R&D):</span>{" "}
